        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto text-center d-flex justify-content-center align-items-center">
              ...
              <Nav.Link href="#home" className='text-secondary fw-bold'>Certificação</Nav.Link>
              <Nav.Link href="#home" className='text-secondary fw-bold'>Serviços</Nav.Link>
              <Nav.Link href="#home" className='text-secondary fw-bold'>Projetos</Nav.Link>
